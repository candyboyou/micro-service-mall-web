<template>
  <modal
    ...
    <b-col class="attribute" style="padding-top: 50px; padding-bottom: 50px" :rules="rules">
      <h4 class="page-title" style="padding-left: 30px">属性 - <span class="fw-semi-bold">新增</span></h4>
      <hr/>
      ...
      <div class="clearfix">
        <div class="float-xl-right">
          <b-button variant="info" class="mr-3" size="sm" right @click="save">提交</b-button>
...
import {getAllList, saveOrUpdateAttribute} from "@/api/business/AttributeDetail";
...
export default {
  ...
  methods: {
    ...
    back() {
      ...
      this.$modal.hide('attributeDetail');
    }
  }
}
